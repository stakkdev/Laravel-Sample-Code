                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'profile_picture'">{{ trans('admin.user.columns.profile_picture') }}</th>
                                        <th is='sortable' :column="'social_id'">{{ trans('admin.user.columns.social_id') }}</th>
                                        <th is='sortable' :column="'login_type'">{{ trans('admin.user.columns.login_type') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>@{{ item.country_code }} - @{{ item.phone_number }} (@{{ item.country_iso_code }})</td>
                                        <td>@{{ item.verified }}</td>
