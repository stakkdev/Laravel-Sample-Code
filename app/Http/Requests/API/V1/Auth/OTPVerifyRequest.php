...
class OTPVerifyRequest extends FormRequest
{
     ...
     * 
     * Where verify_type 1 => send otp on phone, 2 => send otp on email
     * 
     *
     * @return array
     */
    public function rules()
    {
        return [
            ...
            'otp' => 'required|string|regex:/^[1-9][0-9]*$/|min:4|max:4',
            'verify_type' => [
                'required','integer',
            ...
            'password' => 'required_if:action_type,==,'.ActionType::ForgetPassword.'|string|min:8|regex:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%#*?&])[A-Za-z\d@$!%#*?&]{8,}$/',
        ];
    }
}
