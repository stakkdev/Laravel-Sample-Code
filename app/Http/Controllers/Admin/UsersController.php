...
class UsersController extends Controller
{
    ...
    public function index(IndexUser $request)
    {
        ...
        $data = AdminListing::create(User::class)->processRequestAndGet(
            ...
            ['id', 'name', 'email', 'profile_picture', 'social_id', 'login_type', 'country_code', 'phone_number', 'country_iso_code', 'verified'],

            // set columns to searchIn
            ['id', 'name', 'email', 'profile_picture', 'social_id', 'country_code', 'phone_number', 'country_iso_code']
        );
