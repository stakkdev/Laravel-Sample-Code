...
use App\Repositories\API\V1\Interfaces\Common\ICriteria;
use App\Repositories\API\V1\Interfaces\Common\IGenericRepository;

use App\Repositories\API\V1\Common\Criteria;
use App\Repositories\API\V1\Common\RepositoryException;
use Exception;
 ...
 */
abstract class GenericRepository implements IGenericRepository, ICriteria
{
    ...
    {
        $this->applyCriteria();
        return $this->model->where($attribute, '=', $value)->first($columns); //code...}
    }
